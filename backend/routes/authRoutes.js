...
// Check if user exists and return available login methods
router.post('/check-user', async (req, res) => {
  try {
    ...
    const loginMethods = [];
    if (user.password) loginMethods.push('password'); // User has set a password
    loginMethods.push('otp'); // OTP is always available
